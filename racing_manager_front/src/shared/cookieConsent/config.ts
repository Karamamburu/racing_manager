    ...
    translations: {
      ru: {
        consentModal: {
          ...
          description:
            'Портал использует cookies. Сейчас они нужны для авторизации и сохранения вашего выбора. Аналитические и функциональные cookies применяются только после согласия — например, чтобы в будущем рекомендовать гонки по любимой трассе или дисциплине. Подробнее в <a href="/policy/cookies">Политике использования файлов cookie</a>. Вы можете принять или отказаться — мы запомним выбор.',
          acceptAllBtn: 'Принять',
          acceptNecessaryBtn: 'Отказаться',
          showPreferencesBtn: 'Настроить',
          footer: '<a href="/policy/cookies">Политика cookies</a>',
        },
        preferencesModal: {
          ...
          sections: [
            {
              ...
              description:
                'Вы можете принять все cookies, оставить только технические или выбрать категории самостоятельно. Технические cookies нужны для входа в портал и не требуют дополнительного согласия. Подробности — в <a href="/policy/cookies">Политике использования файлов cookie</a>.',
            },
            {
              ...
              cookieTable: {
                ...
                body: [
                  ...
                  {
                    name: 'cc_choice',
                    domain: 'Дублирует выбранные категории согласия',
                    expiration: '6 месяцев',
                  },
                ],
              },
